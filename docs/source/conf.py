...
project = 'cysignals'
copyright = '2016, Martin Albrecht, Jeroen Demeyer'
...
latex_documents = [
  ('index', 'cysignals.tex', 'cysignals Documentation',
   'Martin Albrecht, Jeroen Demeyer', 'manual'),
]
...
man_pages = [
    ('index', 'cysignals', 'cysignals Documentation',
     ['Martin Albrecht, Jeroen Demeyer'], 1)
]
...
texinfo_documents = [
  ('index', 'cysignals', 'cysignals Documentation',
   'Martin Albrecht, Jeroen Demeyer', 'cysignals', 'One line description of project.',
   'Miscellaneous'),
]
